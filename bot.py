...
async def start(msg: types.Message):
    m = await msg.answer(
        "☀️ *Добро пожаловать!*\n"
        "━" * 25 + "\n\n"
        "Я — твой помощник в мире чистоты и порядка.\n\n"
        "✨ *Что я умею:*\n"
        "• Слежу за порядком в чатах и каналах\n"
        "• Защищаю от угроз и агрессии\n"
        "• Помогаю админам управлять сообществами\n"
        "• Автоматически удаляю запрещённый контент\n"
        "• Авто-снятие варнов через 24 часа\n"
        "• Ежедневные отчёты и бонусы\n\n"
        "📌 *Доступные команды:*\n"
